...
class fenPrincipale(QMainWindow):
    def __init__(self):
        ...
        zoneScrollContenu = QScrollArea()
        zoneScrollContenu.setWidgetResizable(True)
        zoneScrollContenu.setWidget(self.labelContenuTrame)
        self.labelF1 = QLabel()
        ...
        layoutOnglet1.addWidget(zoneScrollContenu, 1,0,16,12)
